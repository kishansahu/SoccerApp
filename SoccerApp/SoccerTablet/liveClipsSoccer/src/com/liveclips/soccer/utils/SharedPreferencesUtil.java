...
public class SharedPreferencesUtil {
	...
	public static void saveFavouriteInSharedPreferencesList(Context context,
	...
	public static List<String> getFavouriteInSharedPreferencesList(
			Context context, String entity) {
		SharedPreferences sPrefs = PreferenceManager
				.getDefaultSharedPreferences(context);
		List<String> favList = new ArrayList<String>();
		Integer size = Integer.parseInt((String) sPrefs.getString(entity
				+ "size", "0"));
		if (size > 0) {
			int j = 1;
	...
	public static void removeFavouriteFromSharedPreferencesList(
			Context context, String id, String entity) {
		...
		if (size > 0) {
			for (int j = 1; j <= sPrefs.getAll().size(); j++) {
				...
				if (id.equalsIgnoreCase(favTeam)) {
					...
					int sizeAtPresent = Integer.parseInt(sPrefs.getString(
							entity + "size", "0"));
					sEdit.remove((entity + "size"));
