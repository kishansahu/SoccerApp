 ...
 *
 */
public class HighlightsLeadersListAdapter extends ArrayAdapter<LeadersTypeItem>{
...
private Context context;
	...
	public HighlightsLeadersListAdapter(Context context, int textViewResourceId, List<LeadersTypeItem> leadersTypeItems) {
		...
		LayoutInflater mInflater = (LayoutInflater) context
			...
			if (convertView == null) {
				convertView = mInflater.inflate(
						R.layout.highlights_popover_list_row_item_leader, null);
